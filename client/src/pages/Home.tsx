...
const Home = () => {
  ...
  console.log(data);
  return (
    <div className={` relative ${data.open ? " bg-[#34444c]" : "bg-black"}`}>
      {data.open && <CreatePost />}
      <div
        className={`flex${
          data.open ? " pointer-events-none max-h-[100vh]  opacity-20 overflow-y-hidden" : " pointer-events-auto"
        }`}
      >
        <Sidebar />
        <div className="w-1/2 ">
