  ...
  return (
    <div className='flex'>
        ...
        <div className="w-1/2 flex flex-col">
            ...
            <div className="flex items-center justify-center w-full max-w-[80%] mt-3 ">
          <span className="bg-[#202327] h-8 px-3 flex items-center justify-center rounded-l-3xl text-xs">
            <CiSearch className=" " />
          </span>
          <input
            type="text"
            className="w-full text-xs placeholder:text-xs h-8 rounded-r-3xl bg-[#202327] outline-none"
            placeholder="Search"
          />
        </div>
            </div>
        ...
        <div>
            <h1 className=" font-bold mt-5 px-3 text-lg">Trending hashtags</h1>
        </div>
          </div>
          <div className="w-[30%] py-3 px-2 sticky top-0 overflow-y-auto h-screen border-l border-gray-600">
        
        <div className="bg-[#16181c]  rounded-3xl p-3  ">
          <h1>
            Who to follow
          </h1>
